...
const Hero = () => (
    <section id="home" className={`flex md:flex-row flex-col sm:py-16 py-4 sm:px-16 px-0`}>
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 ss:ml-0 text-center md:text-start`}>
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5 self-center md:self-auto`}>Hi, I'm Sana Minatozaki. A passionate Full Stack Developer based in Manila, Philippines.</p>
